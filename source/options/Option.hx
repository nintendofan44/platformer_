...
class Option
{
	...
	public var showChar:Bool = false;
	public var scrollSpeed:Float = 50; //Only works on int/float, defines how fast it scrolls per second while holding left/right

	private var variable:String = null; //Variable from GameSettings.hx
	...
	{
		return Reflect.getProperty(GameSettings, variable);
	}
	public function setValue(value:Dynamic)
	{
		Reflect.setProperty(GameSettings, variable, value);
	}
