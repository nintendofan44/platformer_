...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("Platformer",00,62,83,96),::ApplicationMain_obj::create_dyn());
...
HXLINE(  35)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("106",77,58,25,00));
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("nintendofan44",fe,b4,c5,d9));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("Platformer",00,62,83,96));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Platformer",00,62,83,96));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.example.myapp",84,30,57,c1));
HXLINE(  40)		app->meta->set(HX_("version",18,e7,f1,7c),HX_("1.0",b3,56,25,00));
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Platformer",00,62,83,96))
