...
::states::TitleScreen_obj::__register();
...
::helpers::AssetPaths_obj::__register();
...
::base::Section_obj::__register();
::base::Conductor_obj::__register();
::Xml_obj::__register();
...
::__ASSET__assets_fonts_dotgothic16_regular_ttf_obj::__register();
...
::ui::CustomFadeTransition_obj::__register();
...
::states::ScoreSubstate_obj::__register();
::states::PlayState_obj::__register();
::states::MusicBeatSubstate_obj::__register();
::states::CourseState_obj::__register();
::states::MusicBeatState_obj::__register();
...
::helpers::Utilities_obj::__register();
...
::flixel::addons::editors::tiled::TiledGroupLayer_obj::__register();
...
::counters::FPS_Mem_obj::__register();
::base::Music_obj::__register();
...
::__ASSET__OPENFL__assets_fonts_dotgothic16_regular_ttf_obj::__register();
...
::__ASSET__assets_fonts_dotgothic16_regular_ttf_obj::__boot();
...
::Xml_obj::__boot();
::base::Conductor_obj::__boot();
::base::Section_obj::__boot();
