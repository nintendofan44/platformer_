...
HXLINE( 145)					if (::Std_obj::isOfType(arr,::hx::ClassOf< ::haxe::IMap >())) {
...
HXLINE( 180)					if (::Std_obj::isOfType(arr,::hx::ClassOf< ::haxe::IMap >())) {
...
HXLINE( 221)				if (::Std_obj::isOfType(arr,::hx::ClassOf< ::haxe::IMap >())) {
...
HXLINE( 515)				if (::Std_obj::isOfType(arr,::hx::ClassOf< ::haxe::IMap >())) {
...
HXLINE( 483)											isAllString = ::Std_obj::isOfType(key,::hx::ClassOf< ::String >());
            										}
            										else {
HXLINE( 483)											isAllString = false;
            										}
HXLINE( 484)										if (isAllInt) {
HXLINE( 484)											isAllInt = ::Std_obj::isOfType(key,::hx::ClassOf< int >());
            										}
            										else {
...
HXDLIN( 646)		return ::Std_obj::isOfType(o,::hx::ClassOf< ::haxe::IMap >());
            	}
