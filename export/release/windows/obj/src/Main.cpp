...
HXLINE(  21)		this->framerate = 60;
HXLINE(  20)		this->zoom = ((Float)-1);
HXLINE(  19)		this->initialState = ::hx::ClassOf< ::states::PlayState >();
...
HXLINE(  72)		this->initialState = ::hx::ClassOf< ::states::TitleScreen >();
HXLINE(  75)		this->addChild( ::flixel::FlxGame_obj::__alloc( HX_CTX ,this->gameWidth,this->gameHeight,this->initialState,this->zoom,this->framerate,this->framerate,this->skipSplash,this->startFullscreen));
HXLINE(  78)		this->counter =  ::counters::FPS_Mem_obj::__alloc( HX_CTX ,10,3,16777215);
HXLINE(  79)		this->addChild(this->counter);
HXLINE(  82)		::flixel::FlxG_obj::autoPause = false;
            	}
...
::hx::Val Main_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 7:
		if (HX_FIELD_EQ(inName,"counter") ) { counter=inValue.Cast<  ::counters::FPS_Mem >(); return inValue; }
		break;
	case 9:
...
static ::hx::StorageInfo Main_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::counters::FPS_Mem */ ,(int)offsetof(Main_obj,counter),HX_("counter",fc,ae,59,1d)},
	{ ::hx::fsUnknown, 0, null()}
};
