...
class BaseOptionsMenu extends MusicBeatSubstate
{
	...
	private var grpTexts:FlxTypedGroup<ConnectedText>;

	private var char:Player = null;
	...
	public function new()
	{
		...
		grpTexts = new FlxTypedGroup<ConnectedText>();
		add(grpTexts);
		...
		for (i in 0...optionsArray.length)
		{
			...
			if(optionsArray[i].type == 'bool') {
				...
				optionText.x -= 80;
				optionText.xAdd -= 80;
				var valueText:ConnectedText = new ConnectedText('' + optionsArray[i].getValue(), optionText.width + 80);
			...
			if(optionsArray[i].showChar && char == null)
			{
				reloadChar();
			}
	...
	function changeSelection(change:Int = 0)
	{
		...
		if(char != null)
		{
			char.visible = optionsArray[curSelected].showChar;
		}
