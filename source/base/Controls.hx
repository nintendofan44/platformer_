...
class Controls extends FlxActionSet
{
	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		keyboardScheme = scheme;
		var keysMap = GameSettings.keyBinds;
		...
		switch (scheme)
		{
			case Solo:
				...
				inline bindKeys(Control.UP, keysMap.get('up'));
				inline bindKeys(Control.DOWN, keysMap.get('down'));
				inline bindKeys(Control.LEFT, keysMap.get('left'));
				inline bindKeys(Control.JUMP, keysMap.get('jump'));
				inline bindKeys(Control.RIGHT, keysMap.get('right'));
			...
			case Duo(true):
				...
				inline bindKeys(Control.JUMP, [SPACE]);
	...
	public function addDefaultGamepad(id):Void
	{
		...
		addGamepadLiteral(id, [
			...
			Control.UP => [DPAD_UP, LEFT_STICK_DIGITAL_UP, RIGHT_STICK_DIGITAL_UP, X],
			Control.DOWN => [DPAD_DOWN, LEFT_STICK_DIGITAL_DOWN, RIGHT_STICK_DIGITAL_DOWN, B],
			Control.LEFT => [DPAD_LEFT, LEFT_STICK_DIGITAL_LEFT, RIGHT_STICK_DIGITAL_LEFT, Y],
